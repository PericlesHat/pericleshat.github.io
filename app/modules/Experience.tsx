                    ...
                    {_map(data, (item, index) => {
                        ...
                        return (
                            <div
                                ...
                                className="self-stretch justify-center items-start gap-2 inline-flex mb-1 last:mb-0" // 将 mb-6 改为 mb-4 或更小的值
                            >
                                <div className="self-stretch flex-col justify-start items-center inline-flex">
                                    ...
                                    {index !== data.length - 1 && ( // 检查不是最后一个元素
                                        <div style={{ width: '0.07rem', height: `calc(100px - 4px)`, backgroundColor: '#eee', marginTop: '0.55rem' }}></div>
                                    )}
                                ...
                                <div className="grow shrink basis-0 self-stretch pt-0.5 justify-center items-start gap-1 flex">
                                    <div className=" min-w-[10rem] text-xs basis-3/12">
                                        ...
                                        <div className="self-stretch justify-start items-start gap-2 inline-flex w-full mt-2">
                                            <div className="w-10 h-10 relative rounded shadow">
                                                <img src={logo} />
                                            </div>
                                    ...
                                    <div className="ml-4 pl-4 grow shrink basis-0 text-slate-500 text-sm font-normal tracking-tight dark:text-gray-400">
                                        <div className="float-right" dangerouslySetInnerHTML={{ __html: Responsibilities }}></div>
                                    </div>
                                </div>
                            </div>
                        )
