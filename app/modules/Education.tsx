                    ...
                    {_map(data, (eduItem, index) => {
                        ...
                        return (
                            <div
                                ...
                                className={` eduitem w-full px-3 py-2 ${isPresent ? 'bg-violet-50' : 'bg-slate-50'
                            ...
                            >
                                ...
                                <div className="self-stretch flex-col justify-start items-end gap-1 inline-flex max-w-[30rem] ml-3">
                                    <div className="px-0.5 py-2 align-text-top text-center text-slate-500 text-xs font-normal leading-3 tracking-tight">
